...
Applies to [the exact scope this guardrail binds]. Does not apply to [exclusion that prevents misuse].
...
<!-- How a breach already merged is undone. Name the revert path and the sign-off. -->

[How the change is reverted and who signs it off]
