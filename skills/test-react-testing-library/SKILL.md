...
## Agreements tests location

- Unit / Component: Co-locate with same folder as the code (the code as *.test.ts). Colocate test files next to the component they test.
